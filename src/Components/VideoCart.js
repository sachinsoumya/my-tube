...
const VideoCart = ({ info }) => {
  ...
  return (
    <div className="shadow-lg w-full  md:w-60 xl:w-60 lg:w-48 rounded-lg my-2 p-2 ">
      <img
      ...
      <div>
        <div className="text-sm md:text-base flex  p-1">
          ...
          <div className="pl-1">
            <div className="font-medium md:font-semibold ">{title}</div>
...
export const AdVideoCard = ({ info }) => {
  return (
    <div className="p-1 m-1 hover:bg-zinc-500 rounded-md md:w-5/6 w-full">
      <VideoCart info={info} />
      <div className="bg-gray-500 text-white hover:bg-black rounded-lg text-center text-xs font-semibold w-1/6">Ad →</div>
    </div>
  );
};
...
export const PlayListCard = ({ info }) => {
  return (
    <div className="relative px-2">
      ...
      <div className="absolute xl:top-28 xl:left-40 lg:top-20 lg:left-32 left-40 top-28  bg-stone-700 text-white p-1 md:text-sm text-xs rounded-md font-medium">
