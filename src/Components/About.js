            ...
            <div>
              ...
              <div className="my-2">
                <ol className="italic font-thin">
                  ...
                  <li className="py-1">
                    <span className="font-normal">TailWind Css</span> - It is
                    used for styling , look and feel of app and also responsive
                    design.
                  </li>
                  <li className="py-1">
                    <span className="font-normal">Redux</span> - It is an
                    external library widely used with react for state
                    management.
                  </li>
                </ol>
              ...
              <div className="my-3">
                ...
                <ol className="italic font-thin list-disc mx-5">
                  ...
                  <li className="py-1">
                    List of videos as per search results.
                  </li>
